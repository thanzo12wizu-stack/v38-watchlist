...
def _liq_bar():
    ...
    return (
        ...
        '<button class="lqf-b active" onclick="liqFilter(-1,this)">全て</button>'
        '<button class="lqf-b lqf-rec" onclick="liqFilter(10,this)">≥$10M<span class="lqf-tag">推奨</span></button>'
...
def render(names, m, mri, breakdown, dropped, aux, setups, picks, cand,
    ...
    sector = (_sector_etf_table(mkt.get("sector_etf", []))
              + f'<div class="card"><h2>サブテーマ別RS（ユニバース内）</h2>'
