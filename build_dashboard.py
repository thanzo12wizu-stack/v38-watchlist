...
OV1_TPL_B64 = ""
...
def build_overview_cards(ctx):
    ...
    try:
        ...
        try:
            ...
            doc1 = _re2.sub(r'VIX [\d.—]+',
                            lambda mm: (f'VIX {vix:.1f}' if isinstance(vix, (int, float)) else 'VIX —'), doc1, count=1)
            pc = senti.get("pc") or senti.get("put_call") or (perf.get("pc") if isinstance(perf, dict) else None)
            doc1 = _re2.sub(r'P/C [\d.—]+',
                            lambda mm: (f'P/C {pc:.2f}' if isinstance(pc, (int, float)) else 'P/C —'), doc1, count=1)
        except Exception:
            pass
        ...
        try:
            ...
            doc1 = _re2.sub(r'(米2年 / 10年名目</span><span class="v num">)[^<]*(</span>)',
                            lambda mm: mm.group(1) + _pair(y2, y10) + mm.group(2), doc1, count=1)
            doc1 = _re2.sub(r'(10年実質 / 期待ｲﾝﾌﾚ</span><span class="v num">)[^<]*(</span>)',
                            lambda mm: mm.group(1) + _pair(y10r, infl) + mm.group(2), doc1, count=1)
            doc1 = _re2.sub(r'(10-2 スプレッド</span><span class="v num[^"]*">)[^<]*(</span>)',
                            lambda mm: mm.group(1) + (('%+.2f' % slope) if slope is not None else '—') + mm.group(2), doc1, count=1)
            doc1 = _re2.sub(r'(HY OAS / NFCI</span><span class="v num">)[^<]*(</span>)',
                            lambda mm: mm.group(1) + (('%.2f / %+.2f' % (hy, nfci)) if (hy is not None and nfci is not None) else '— / —') + mm.group(2), doc1, count=1)
            doc1 = _re2.sub(r'(広義ドル指数</span><span class="v num">)[\d.—]+',
                            lambda mm: mm.group(1) + (('%.1f' % dxy) if dxy is not None else '—'), doc1, count=1)
        except Exception:
            pass
        ...
        try:
            ...
            if cx1:
                ...
                doc1 = _re2.sub(r'(<div class="cl">今日</div><div class="cx">)[^<]*(</div>)',
                                lambda mm: mm.group(1) + "データ準備中。" + mm.group(2), doc1, count=1)
    ...
    _SAMPLE_SENTINELS = ["2026-07-15", "$12.4B", "$28.6B", ">12.4B<", ">28.6B<",
                         "Green 32", "Yellow 21", "Red 7", "P/C 0.92", "VIX 15.7",
                         "06-25", "14日連続", "リーダー数 24", "24 / 18 / 31",
                         "金融・地銀・ブローカー", "半導体・電力/防衛", "Top10継続8/10", "1D +3", "1W +6"]
    for _doc_name in ("doc1", "doc2"):
        _d = doc1 if _doc_name == "doc1" else doc2
        _hit = [mk for mk in _SAMPLE_SENTINELS if mk in _d]
        if _hit:
            sys.stderr.write("[overview] sample value remained -> masked: %r\n" % _hit)
            for mk in _hit:
                _d = _d.replace(mk.strip("<>"), "—") if not mk.startswith(">") else _d.replace(mk, ">—<")
            if _doc_name == "doc1":
                doc1 = _d
            else:
                doc2 = _d
...
def build_regime_alerts(m, st=None, collapsible=False, hist=None):
    ...
    try:
        ...
        return (
            ...
            f'<p class="fver">※上記の検証成績（19/22・1.84倍・+28.8% 等）は <b>logic {LOGIC_VERSION}</b>／検証データ {BACKTEST_THROUGH} 時点で算出。ロジック変更時は再検証までの暫定値。</p>'
...
def _spark(vals, asof=None, days=60, color="#6f93c9"):
    ...
    try:
        ...
        gid = "spk%d" % (abs(hash((color, n, round(ys[-1], 4)))) % 100000)
    ...
    def _synth_rows(ts):
        ...
        for t in ts:
            ...
            rows.append(
                ...
                f'<td><div class="thcell"><span class="thnm">{th}</span>'
...
/* ===== #6 Core 12の実建値・状態は v38_holdings(strat=core) を唯一のソースにする（旧 cc_ 各ストアと v38_entered を統合） ===== */
function _coreRec(tk){ var a=hldLoad(); tk=String(tk).toUpperCase(); for(var i=0;i<a.length;i++){ if(a[i].strat==='core' && String(a[i].t).toUpperCase()===tk && a[i].status!=='closed') return i; } return -1; }
function _coreEnsure(tk){ var i=_coreRec(tk); if(i>=0) return i; var a=hldLoad(); a.push({t:String(tk).toUpperCase(), strat:'core', status:'open', px:null, avgPx:null, sh:null, dt:(typeof _hldToday==='function'?_hldToday():''), leg2:'none', exits:[], partialDone:false, remainingShares:null, filled:false, coreSold:false}); hldSave(a); return a.length-1; }
function _corePrune(tk){ var i=_coreRec(tk); if(i<0) return; var a=hldLoad(), h=a[i];
  if(!(h.px>0) && !h.filled && !h.coreSold && !(h.exits&&h.exits.length) && !h.memo && !h.setup && !(h.sh>0)){ a.splice(i,1); hldSave(a); } }
function coreEntry(tk){ var i=_coreRec(tk); if(i<0) return null; var h=hldLoad()[i]; return (h.avgPx||h.px||null); }
function coreSetEntry(tk,px){ var i=(px>0)?_coreEnsure(tk):_coreRec(tk); if(i<0){ return; } var a=hldLoad(); if(px>0){ a[i].px=px; a[i].avgPx=px; } else { a[i].px=null; a[i].avgPx=null; } hldSave(a); if(!(px>0)) _corePrune(tk); }
function coreSold(tk){ var i=_coreRec(tk); if(i<0) return false; return !!hldLoad()[i].coreSold; }
function coreToggleSold(tk){ var i=_coreEnsure(tk); var a=hldLoad(); a[i].coreSold=!a[i].coreSold; hldSave(a); if(!a[i].coreSold) _corePrune(tk); }
function coreFilled(tk){ var i=_coreRec(tk); if(i<0) return false; return !!hldLoad()[i].filled; }
function coreToggleFilled(tk){ var i=_coreEnsure(tk); var a=hldLoad(); a[i].filled=!a[i].filled; hldSave(a); if(!a[i].filled) _corePrune(tk); }
function coreHeldTickers(){ return hldLoad().filter(function(h){return h.strat==='core' && h.status!=='closed' && (h.px>0);}).map(function(h){return String(h.t).toUpperCase();}); }
function _coreMigrate(){
  try{
    if(localStorage.getItem('v38_core_migrated')==='1') return;
    var ent=ccLoad(ccKey()), sold=takenLoad(), filled=_entLoad();
    var keys={}; [ent,sold,filled].forEach(function(o){Object.keys(o||{}).forEach(function(k){keys[k]=1;});});
    Object.keys(keys).forEach(function(tk){
      if(_coreRec(tk)>=0) return;
      var px=parseFloat((ent||{})[tk]); var i=_coreEnsure(tk); var a=hldLoad();
      if(px>0){ a[i].px=px; a[i].avgPx=px; }
      a[i].coreSold=!!(sold||{})[tk]; a[i].filled=!!(filled||{})[tk]; hldSave(a); _corePrune(tk);
    });
    localStorage.setItem('v38_core_migrated','1');
  }catch(e){}
}
function toggleTaken(t){ coreToggleSold(t); calcRun(); }
function plHtml(n,e,tk){
  if(!e) return '<span class="mut">建値未入力</span>';
  var pl=(n.px/e-1)*100;                       // 損益は実建値ベース
  // #5 実ポジション管理: 出口も【実建値】基準に統一（損益と同じ基準）。
  //   初期ストップ = 実建値×0.75、トレール = ピーク×0.70（ピークは客観値・Python追跡を優先）。
  var initial=e*0.75;
  var pk=(n.sysPeak!=null)?n.sysPeak:ccPeak(n.t,n.px,e);
  ...
  return '<span class="'+(pl>=0?'pos':'neg')+'" style="font-weight:700">'+(pl>=0?'+':'')+pl.toFixed(1)+'%</span>'
       + '<div class="mut" style="font-size:10px">出口 $'+Number(stop).toFixed(2)+' ('+which+'・実建値基準)'+brk+'</div>';
}
function entSave(el){
...
function hldSave(a){ try{ localStorage.setItem(hldKey(), JSON.stringify(a)); return true; }catch(e){ try{alert('保存に失敗しました（容量超過など）。JSONバックアップで退避してください。');}catch(e2){} return false; } }
function _daysBetween(start,end){ try{ if(!start||!end) return null; var a=new Date(start+'T00:00:00'), b=new Date(end+'T00:00:00'); if(isNaN(a)||isNaN(b)) return null; return Math.max(0, Math.floor((b.getTime()-a.getTime())/86400000)); }catch(e){ return null; } }
function currentSwingStop(h){ var d=(window.DET||{})[h.t]||{}; if(h.exitType==='e21l'&&d.e21l!=null) return d.e21l; if(h.exitType==='s10'&&d.s10!=null) return d.s10; return (h.stop!=null?h.stop:null); }
...
function _hldStratMeta(s){
  return (s==='swing')
    ? {lab:'裁量', cls:'strat-swing', exit:'+25%で1/3利確 → 残りは21EMA割れ/撤退でトレール'}
    : {lab:'Core 12', cls:'strat-core', exit:'ピーク×0.70 または 建値×0.75（途中利確しない）'};
}
...
function _hldEnv(tk){var C=window.CALC||{}, D=window.DET||{}, d=D[tk]||{};return {envColor:(C.color||''), eRS63:(d.rs!=null?d.rs:null), eRS189:(d.rs189!=null?d.rs189:null), theme:(d.sth||d.sec||''), entryPx:(d.px!=null?d.px:null), envAsOf:(new Date()).toLocaleDateString('sv-SE')};}
...
function hldAdd(){
  ...
  var a=hldLoad();
  var _dup=a.filter(function(x){return String(x.t).toUpperCase()===tk && x.status!=='closed';}).length;
  if(_dup>0){ try{ if(!window.confirm(tk+' は既に'+_dup+'件の保有中記録があります。別記録として追加しますか？')) return; }catch(e){} }
  a.push(Object.assign({t:tk, sh:sh, px:px, avgPx:px, dt:dt, strat:_hldStratVal(), status:'open', leg2:'none',
    initialStop:null, exits:[], partialDone:false, remainingShares:sh}, _hldNoteIn(), _hldEnv(tk))); hldSave(a);
  tkEl.value=''; var s=document.getElementById('hldSh'); if(s)s.value=''; var p=document.getElementById('hldPx'); if(p)p.value=''; var d=document.getElementById('hldDt'); if(d)d.value=''; _hldClearNote();
  hldRender();
}
...
function _hldEff(h){
  // 実効（約定済み脚のみ）の株数・加重平均建値を返す。第2脚が未約定なら第1脚のみ。
  if(h.leg2==='planned'||h.leg2==='filled'){
    var s1=(h.sh1||0), p1=(h.px1||0), s2=(h.sh2||0), p2=(h.px2||0);
    if(h.leg2==='filled' && s2>0){ var tot=s1+s2; return {sh:tot, avg:tot>0?(s1*p1+s2*p2)/tot:null}; }
    return {sh:(s1>0?s1:null), avg:(s1>0?p1:null)};
  }
  return {sh:(h.sh!=null?h.sh:null), avg:(h.avgPx||h.px||null)};
}
function hldFromPlan(){
  var p=window._lastPlan||{};
  if(!p||!(p.avgPx>0||p.px>0)){ try{alert('有効なプランがありません。上で再計算してください。');}catch(e){} return; }
  var tkIn=document.getElementById('hldTk');
  var tk=(p.t||'').trim().toUpperCase() || (tkIn&&(tkIn.value||'').trim()?(tkIn.value||'').trim().toUpperCase():'');
  if(!tk){ try{alert('上のプランで銘柄を入力してください');}catch(e){} return; }
  var pxManual=parseFloat((document.getElementById('hldPx')||{}).value);
  var shManual=parseFloat((document.getElementById('hldSh')||{}).value);
  var dt=((document.getElementById('hldDt')||{}).value)||_hldToday();
  var tpPct=(p.tpPct||25), tpFraction=(p.tpFraction||33);
  var hasLeg2=(p.hasLeg2===true && p.sh2>0 && p.px2>0);
  if(!(p.stop>0)){ try{ if(!window.confirm(tk+'：撤退（初期ストップ）が未設定です。このまま記録すると実現Rが計算できません（後で「編集」から初期ストップを入れれば計算されます）。記録しますか？')) return; }catch(e){} }
  var rec={t:tk, strat:"swing", dt:dt, status:'open',
           stop:p.stop, initialStop:p.stop, exitType:p.exitType, exitLabel:p.exitLabel,
           tpPct:tpPct, tpFraction:tpFraction, exits:[], partialDone:false};
  if(pxManual>0 || shManual>0 || !hasLeg2){
    // 手入力上書き or 単一エントリー → 1脚のみ約定として扱う（脚別は保持しない）
    var eSh=(shManual>0?shManual:(p.sh1>0?p.sh1:(p.sh||null)));
    var eAvg=(pxManual>0?pxManual:(p.px1>0?p.px1:(p.avgPx||p.px||null)));
    rec.leg2='none'; rec.sh=eSh; rec.px=eAvg; rec.avgPx=eAvg; rec.remainingShares=eSh;
  }else{
    // 2脚プラン → 第1脚=約定、第2脚=予定（未約定）。実効は第1脚のみ。
    rec.sh1=p.sh1; rec.px1=p.px1; rec.sh2=p.sh2; rec.px2=p.px2; rec.leg2='planned';
    rec.sh=p.sh1; rec.px=p.px1; rec.avgPx=p.px1; rec.remainingShares=p.sh1;
  }
  rec.tpPrice=(rec.avgPx!=null)?(rec.avgPx*(1+tpPct/100)):null;
  rec.tpShares=(rec.sh!=null)?Math.floor(rec.sh*tpFraction/100):null;
  var a=hldLoad();
  var _dupP=a.filter(function(x){return String(x.t).toUpperCase()===tk && x.status!=='closed';}).length;
  if(_dupP>0){ try{ if(!window.confirm(tk+' は既に'+_dupP+'件の保有中記録があります。別記録として追加しますか？')) return; }catch(e){} }
  a.push(Object.assign(rec, _hldNoteIn(), _hldEnv(tk))); hldSave(a);
  if(tkIn)tkIn.value=''; var s=document.getElementById('hldSh'); if(s)s.value=''; var pp=document.getElementById('hldPx'); if(pp)pp.value=''; var d=document.getElementById('hldDt'); if(d)d.value=''; _hldClearNote();
  hldRender();
}
function hldFillLeg2(ev,i){
  if(ev&&ev.stopPropagation)ev.stopPropagation();
  var a=hldLoad(); if(i<0||i>=a.length) return; var h=a[i];
  if(h.leg2!=='planned') return;
  try{
    var pr=window.prompt('【'+h.t+'】第2脚の約定価格（予定 $'+(h.px2||0)+'）', h.px2||'');
    if(pr===null) return; var price=parseFloat(pr); if(!(price>0)){ alert('価格が不正です'); return; }
    var shr=window.prompt('【'+h.t+'】第2脚の約定株数（予定 '+(h.sh2||0)+'株）', h.sh2||'');
    if(shr===null) return; var shares=parseFloat(shr); if(!(shares>0)){ alert('株数が不正です'); return; }
    h.px2=price; h.sh2=shares; h.leg2='filled';
    var e=_hldEff(h); h.sh=e.sh; h.avgPx=e.avg; h.px=e.avg;
    h.remainingShares=(h.remainingShares!=null?h.remainingShares:0)+shares;
    if(h.tpPct!=null&&h.avgPx!=null) h.tpPrice=h.avgPx*(1+h.tpPct/100);
    if(h.sh!=null) h.tpShares=Math.floor(h.sh*(h.tpFraction||33)/100);   // #2 合計株数から利確株数を再計算
    a[i]=h; hldSave(a); hldRender();
  }catch(e){}
}
function _hldOrigSh(h){ var ex=(h.exits||[]).reduce(function(s,e){return s+(e.shares||0);},0); return (h.remainingShares!=null?h.remainingShares:0)+ex; }
function _hldRecordExit(h, o){
  // 決済を記録する。損益・原価(costBasis)を【決済時点の実効平均建値】で固定保存し、以後書き換えない。
  var avg=_hldEff(h).avg;
  var cb=(avg!=null?avg:null);
  var pnl=(cb!=null && o.price!=null && o.shares!=null)?((o.price-cb)*o.shares):null;
  h.exits=h.exits||[];
  h.exits.push({type:o.type||'partial', date:o.date, price:o.price, shares:o.shares, reason:o.reason||'',
                costBasis:cb, initialStopAt:(h.initialStop!=null?h.initialStop:null), realizedPnl:pnl});
}
function _hldRealized(h){
  // 実現損益・Rは【決済時に固定保存した値】の合計。現在の平均建値からは再計算しない（後から書き換わらない）。
  var exits=h.exits||[];
  var pnl=0, shExited=0, rSum=0, rShares=0, anyFixed=false;
  var effAvg=_hldEff(h).avg;
  exits.forEach(function(x){
    var cb=(x.costBasis!=null)?x.costBasis:effAvg;           // 旧記録はcostBasisが無いので実効avgで代替
    var iStop=(x.initialStopAt!=null)?x.initialStopAt:h.initialStop;
    var xpnl=(x.realizedPnl!=null)?x.realizedPnl:((cb!=null&&x.price!=null&&x.shares!=null)?(x.price-cb)*x.shares:null);
    if(x.realizedPnl!=null) anyFixed=true;
    if(xpnl!=null){ pnl+=xpnl; }
    if(x.shares!=null) shExited+=x.shares;
    if(cb!=null && iStop!=null && x.price!=null && x.shares!=null){
      var risk=cb-iStop;
      if(risk>0){ rSum+=((x.price-cb)/risk)*x.shares; rShares+=x.shares; }
    }
  });
  var orig=_hldOrigSh(h);
  var R=(rShares>0 && orig>0)?(rSum/orig):null;   // 当初株数に対する加重平均R（各決済のRは固定）
  return {pnl:pnl, shExited:shExited, R:R, orig:orig};
}
function _hldFinalize(h, closeDate){
  // 決済確定処理（部分決済で残0になった場合も全決済も必ずここを通す）
  var r=_hldRealized(h); h.realizedPnl=r.pnl; h.realizedR=r.R; h.status='closed';
  h.closeDate=closeDate||h.closeDate||_hldToday();
  h.heldDays=_daysBetween(h.dt, h.closeDate);   // #8 決済日基準（今日ではなく）
}
function hldTakePartial(ev,i){
  if(ev&&ev.stopPropagation)ev.stopPropagation();
  var a=hldLoad(); if(i<0||i>=a.length) return; var h=a[i];
  var e=_hldEff(h), defShares=h.tpShares||(e.sh?Math.floor(e.sh*(h.tpFraction||33)/100):null);
  var D=window.DET||{}, curPx=(D[h.t]&&D[h.t].px!=null)?D[h.t].px:'';
  try{
    var pr=window.prompt('【'+h.t+'】部分利確：約定価格', (h.tpPrice?(+h.tpPrice).toFixed(2):curPx));
    if(pr===null) return; var price=parseFloat(pr); if(!(price>0)){ alert('価格が不正です'); return; }
    var rem=(h.remainingShares!=null?h.remainingShares:e.sh)||0;
    var shr=window.prompt('【'+h.t+'】部分利確：株数（残 '+rem+'株）', defShares||'');
    if(shr===null) return; var shares=parseFloat(shr); if(!(shares>0)){ alert('株数が不正です'); return; }
    if(shares>=rem){ if(!window.confirm('残株すべて（'+rem+'株）を売却＝全決済になります。よろしいですか？')) return; shares=rem; }
    var dt=window.prompt('【'+h.t+'】決済日(YYYY-MM-DD)', _hldToday()); if(dt===null) return;
    var closing=(shares>=rem);
    var rsn=window.prompt('【'+h.t+'】'+(closing?'手仕舞い理由':'理由（TP1/利確 等・任意）'), closing?(h.exitReason||''):'TP'); if(rsn===null) rsn='';
    _hldRecordExit(h, {type:(closing?'final':'partial'), date:dt, price:price, shares:shares, reason:rsn});
    h.remainingShares=Math.max(0, rem-shares); h.partialDone=true;
    if(closing){   // #7 全株売却は全決済と同じ確定処理を通す
      h.exitReason=rsn;
      var ls=window.prompt('【'+h.t+'】学び・次に活かす1点（任意）', h.lesson||''); if(ls!==null) h.lesson=ls;
      _hldFinalize(h, dt);
    }
    a[i]=h; hldSave(a); hldRender();
  }catch(e2){}
...
function hldClose(ev,i){
  if(ev&&ev.stopPropagation)ev.stopPropagation();
  var a=hldLoad(); if(i<0||i>=a.length) return; var h=a[i];
  var e=_hldEff(h), rem=(h.remainingShares!=null?h.remainingShares:e.sh)||0;
  var D=window.DET||{}, curPx=(D[h.t]&&D[h.t].px!=null)?D[h.t].px:'';
  try{
    var dt=h.closeDate||_hldToday();
    if(rem>0){
      var pr=window.prompt('【'+h.t+'】全決済：約定価格（残 '+rem+'株）', curPx);
      if(pr===null) return; var price=parseFloat(pr); if(!(price>0)){ alert('価格が不正です'); return; }
      dt=window.prompt('【'+h.t+'】決済日(YYYY-MM-DD)', _hldToday()); if(dt===null) return;
      var rsn=window.prompt('【'+h.t+'】手仕舞い理由（ストップ/利確/21EMA割れ/裁量 等）', h.exitReason||''); if(rsn===null) rsn='';
      _hldRecordExit(h, {type:'final', date:dt, price:price, shares:rem, reason:rsn});
      h.remainingShares=0; h.exitReason=rsn;
    }
    var ls=window.prompt('【'+h.t+'】学び・次に活かす1点（任意）', h.lesson||''); if(ls!==null) h.lesson=ls;
    _hldFinalize(h, dt);
    a[i]=h; hldSave(a); hldRender();
...
function hldEditClosed(ev,i){
  // 決済済み記録の訂正（最終決済の価格・株数・日付・手仕舞い理由）。損益・Rを再固定。
  if(ev&&ev.stopPropagation)ev.stopPropagation();
  var a=hldLoad(); if(i<0||i>=a.length) return; var h=a[i];
  var exits=h.exits||[]; if(!exits.length){ alert('決済履歴がありません'); return; }
  var last=exits[exits.length-1];
  try{
    var pr=window.prompt('【'+h.t+'】最終決済の約定価格を訂正', last.price!=null?last.price:''); if(pr===null) return;
    var price=parseFloat(pr); if(!(price>0)){ alert('価格が不正です'); return; }
    var shr=window.prompt('【'+h.t+'】最終決済の株数を訂正', last.shares!=null?last.shares:''); if(shr===null) return;
    var shares=parseFloat(shr); if(!(shares>0)){ alert('株数が不正です'); return; }
    var dt=window.prompt('【'+h.t+'】決済日を訂正(YYYY-MM-DD)', last.date||h.closeDate||''); if(dt===null) return;
    var rsn=window.prompt('【'+h.t+'】手仕舞い理由を訂正', h.exitReason||last.reason||''); if(rsn===null) rsn=last.reason||'';
    // 残株を戻して株数差を反映
    var prevSh=last.shares||0;
    last.price=price; last.shares=shares; last.date=dt; last.reason=rsn;
    // 損益を再固定（costBasisはそのまま＝決済時点の原価を維持）
    if(last.costBasis!=null) last.realizedPnl=(price-last.costBasis)*shares;
    h.remainingShares=Math.max(0,(h.remainingShares||0)+(prevSh-shares));
    h.exitReason=rsn;
    if(h.remainingShares>0){ h.status='open'; h.closeDate=null; }   // 株が残るなら保有中に戻る（履歴整合）
    else { _hldFinalize(h, dt); }
    a[i]=h; hldSave(a); hldRender();
  }catch(e){}
}
function hldNote(ev,i){
  if(ev&&ev.stopPropagation)ev.stopPropagation();
  var a=hldLoad(); if(i<0||i>=a.length) return; var h=a[i];
  try{
    var memo=window.prompt('【'+h.t+'】エントリー理由・見立て（なぜ今か／トリガー／想定リスク）', h.memo||'');
    if(memo===null) return; h.memo=memo;
    var ls=window.prompt('【'+h.t+'】学び・次に活かす1点（任意）', h.lesson||'');
    if(ls!==null) h.lesson=ls;
    a[i]=h; hldSave(a); hldRender();
  }catch(e){}
}
function hldEdit(ev,i){
  if(ev&&ev.stopPropagation)ev.stopPropagation();
  var a=hldLoad(); if(i<0||i>=a.length) return; var h=a[i]; var e=_hldEff(h);
  var hasExits=!!(h.exits&&h.exits.length);
  try{
    if(hasExits){
      if(!window.confirm('この記録は決済履歴があります。平均建値の変更は既存の決済損益（固定値）には影響しません。続けますか？')) return;
    }
    var pxv=window.prompt('【'+h.t+'】平均建値を修正', e.avg!=null?e.avg:'');
    if(pxv===null) return; var px=parseFloat(pxv);
    var shv=window.prompt('【'+h.t+'】株数を修正', e.sh!=null?e.sh:'');
    if(shv===null) return; var sh=parseFloat(shv);
    var dtv=window.prompt('【'+h.t+'】取得日を修正(YYYY-MM-DD)', h.dt||''); if(dtv===null) return;
    // #4 初期ストップ(R基準・固定)と現在ストップ(トレール)は別項目。通常のトレール更新でRの基準を変えない。
    var isv=window.prompt('【'+h.t+'】初期ストップ＝R計算の基準（訂正のみ。空欄可）', h.initialStop!=null?h.initialStop:''); if(isv===null) return;
    var csv=window.prompt('【'+h.t+'】現在ストップ＝トレール（引き上げても初期は変わらない。空欄可）', h.stop!=null?h.stop:''); if(csv===null) return;
    if(px>0){ h.px=px; h.avgPx=px; h.leg2='none'; h.sh1=null; h.sh2=null; }
    if(sh>0){ h.sh=sh; if(!hasExits) h.remainingShares=sh; }
    if(dtv) h.dt=dtv;
    var is=parseFloat(isv); h.initialStop=(is>0?is:null);
    var cs=parseFloat(csv); h.stop=(cs>0?cs:h.stop);
    a[i]=h; hldSave(a); hldRender();
  }catch(e2){}
}
function _mdRow(h){
  var e=_hldEff(h), avg=e.avg, sh=e.sh, orig=_hldOrigSh(h);
  var D=window.DET||{}, cur=(D[h.t]&&D[h.t].px!=null)?D[h.t].px:null;
  var closed=(h.status==='closed');
  var L=[];
  L.push('## '+h.t+(h.strat==='core'?'（Core 12）':'（裁量スイング）')+(h.dt?'  ['+h.dt+']':'')+(closed?'  ✅決済済み':''));
  var l1=[]; if(h.setup)l1.push('セットアップ: '+h.setup); if(h.conv)l1.push('確信度: '+h.conv); if(h.envColor)l1.push('環境(NQ): '+h.envColor);
  if(l1.length) L.push('- '+l1.join(' ／ '));
  var l2=[]; if(avg!=null)l2.push('平均建値: $'+(+avg).toFixed(2)); if(sh!=null)l2.push('株数: '+sh);
  if(h.leg2==='planned')l2.push('※第2脚 未約定（予定 '+(h.sh2||0)+'株@$'+(h.px2||0)+'）');
  if(h.eRS63!=null||h.eRS189!=null)l2.push('入口RS63/189: '+(h.eRS63!=null?h.eRS63:'—')+'/'+(h.eRS189!=null?h.eRS189:'—'));
  if(h.theme)l2.push('テーマ: '+h.theme);
  if(l2.length) L.push('- '+l2.join(' ／ '));
  var l3=[]; if(h.initialStop!=null)l3.push('初期ストップ: $'+(+h.initialStop).toFixed(2)); if(h.stop!=null&&h.stop!==h.initialStop)l3.push('現ストップ: $'+(+h.stop).toFixed(2));
  if(l3.length) L.push('- '+l3.join(' ／ '));
  if(h.memo) L.push('- **理由/見立て**: '+h.memo);
  if(h.exits&&h.exits.length){
    L.push('- **決済履歴**:');
    h.exits.forEach(function(x){ L.push('  - '+(x.date||'')+' '+(x.type==='final'?'全決済':'部分')+' '+(x.shares||0)+'株 @ $'+(x.price!=null?(+x.price).toFixed(2):'—')+(x.reason?'（'+x.reason+'）':'')); });
  }
  if(closed){
    var r=_hldRealized(h);
    if(r.pnl!=null) L.push('- **実現損益（株ベース）**: '+(r.pnl>=0?'+':'')+'$'+r.pnl.toFixed(2)+(r.R!=null?'（'+(r.R>=0?'+':'')+r.R.toFixed(2)+'R）':'（R=初期ストップ未設定）'));
    if(h.heldDays!=null) L.push('- 経過日数: '+h.heldDays+'日（暦日）');
    if(h.exitReason) L.push('- **手仕舞い**: '+h.exitReason);
  }else{
    if(h.remainingShares!=null&&orig!=null&&h.remainingShares!==orig) L.push('- 残株: '+h.remainingShares+'/'+orig);
    if(cur!=null){ var pl=(avg!=null)?((cur/avg-1)*100):null; L.push('- 現在値: $'+cur+(pl!=null?'（'+(pl>=0?'+':'')+pl.toFixed(1)+'%）':'')); }
  }
  if(h.lesson) L.push('- **学び**: '+h.lesson);
  return L.join('\n');
}
function hldExport(){
  var a=hldLoad();
  if(!a.length){ try{alert('記録がありません。');}catch(e){} return; }
  var today=(new Date()).toLocaleDateString('sv-SE');
  var open=a.filter(function(h){return h.status!=='closed';}), closed=a.filter(function(h){return h.status==='closed';});
  var md='# トレードノート（書き出し '+today+'）\n\n記録はこの端末にのみ保存。環境（NQ/RS/テーマ）は記録日時点のスナップショットで、取得日当時の値ではありません。\n\n';
  md+='# ■ 保有中（'+open.length+'件）\n\n'+(open.length?open.map(_mdRow).join('\n\n---\n\n'):'なし')+'\n\n';
  md+='# ■ 決済済み（'+closed.length+'件）\n\n'+(closed.length?closed.map(_mdRow).join('\n\n---\n\n'):'なし')+'\n';
  if(closed.length){
    var rs=closed.map(function(h){return _hldRealized(h).R;}).filter(function(x){return x!=null;});
    if(rs.length){ var wins=rs.filter(function(x){return x>0;}).length; var sum=rs.reduce(function(s,x){return s+x;},0);
  ...
  var done=false;
  try{ if(navigator.clipboard&&navigator.clipboard.writeText){ navigator.clipboard.writeText(md); done=true; } }catch(e){}
  try{ window.prompt(done?'クリップボードにコピー済み。必要なら手動でもコピーできます：':'下記を選択してコピーしてください：', md); }catch(e){}
}
function hldExportJSON(){
  var a=hldLoad();
  var payload=JSON.stringify({schemaVersion:2, exportedAt:(new Date()).toISOString(), trades:a});
  var done=false;
  try{ if(navigator.clipboard&&navigator.clipboard.writeText){ navigator.clipboard.writeText(payload); done=true; } }catch(e){}
  try{ window.prompt((done?'JSONをクリップボードにコピー済み。':'')+'このJSONを保存すると復元できます（バックアップ）：', payload); }catch(e){}
}
function _hldNormalize(h){
  // 復元/取込レコードの正規化。欠損フィールドを安全な既定値で補い、壊れた記録を弾く。
  if(!h||typeof h!=='object'||!h.t) return null;
  h.t=String(h.t).toUpperCase();
  if(h.strat!=='core'&&h.strat!=='swing') h.strat='swing';
  if(h.status!=='closed') h.status='open';
  if(!Array.isArray(h.exits)) h.exits=[];
  if(!h.leg2) h.leg2='none';
  // 実効株数から残株の整合を取る（欠損時）
  if(h.remainingShares==null){ var e=_hldEff(h); h.remainingShares=(h.status==='closed')?0:(e.sh!=null?e.sh:null); }
  return h;
}
function hldImportJSON(){
  try{
    var s=window.prompt('バックアップJSONを貼り付けてください（現在の記録に追加）', '');
    if(!s) return;
    var obj=JSON.parse(s);
    var incoming=Array.isArray(obj)?obj:(obj&&Array.isArray(obj.trades)?obj.trades:null);
    if(!incoming){ alert('形式が不正です（trades配列が見つかりません）'); return; }
    var sv=(obj&&!Array.isArray(obj))?obj.schemaVersion:null;
    var norm=incoming.map(_hldNormalize).filter(function(x){return x;});
    if(!norm.length){ alert('有効な記録が見つかりません'); return; }
    var skipped=incoming.length-norm.length;
    if(!window.confirm(norm.length+'件を現在の記録に追加しますか？'+(skipped>0?'（不正 '+skipped+'件はスキップ）':'')+(sv?'　schema v'+sv:''))) return;
    var a=hldLoad(); a=a.concat(norm); if(hldSave(a)){ hldRender(); alert(norm.length+'件を取り込みました'); }
  }catch(e){ try{alert('JSONの解析に失敗しました');}catch(e2){} }
}
function _escH(s){return String(s==null?'':s).replace(/[&<>"']/g,function(c){return {'&':'&amp;','<':'&lt;','>':'&gt;','"':'&quot;',"'":'&#39;'}[c];});}
function _hldOpenRow(h,i){
  var D=window.DET||{}, e=_hldEff(h), avg=e.avg, sh=e.sh, orig=_hldOrigSh(h);
  var days=_hldDays(h.dt);
  var cur=(D[h.t]&&D[h.t].px!=null)?D[h.t].px:null;
  var pl=(cur!=null&&avg!=null)?((cur/avg-1)*100):null;
  ...
  var meta=_hldStratMeta(h.strat);
  var swx='';
  if(h.leg2==='planned'){
    swx+='<div class="hld-leg"><b class="warnc">第2脚 未約定</b>（予定 '+(h.sh2||0)+'株@$'+(h.px2||0)+'）</div>'
       +'<button class="tkbtn hld-legb" onclick="hldFillLeg2(event,'+i+')">第2脚を約定にする</button>';
  }
  if(h.strat==='swing'){
    var lines=[];
    var curStop=currentSwingStop(h);
    if(curStop!=null&&cur!=null){ if(cur<=curStop){ lines.push('<b class="neg">撤退ライン割れ</b> $'+(+curStop).toFixed(2)); } else { var sd=(curStop/cur-1)*100; lines.push('撤退（現在）$'+(+curStop).toFixed(2)+'まで '+sd.toFixed(1)+'%'); } }
    if(h.initialStop!=null) lines.push('<span class="mut">初期$'+(+h.initialStop).toFixed(2)+'＝R基準（固定）</span>');
    if(h.tpPrice&&cur!=null&&h.remainingShares>0){ if(cur>=h.tpPrice){ lines.push('<b class="pos">部分利確ライン到達</b> $'+(+h.tpPrice).toFixed(2)); } else { var td=(h.tpPrice/cur-1)*100; lines.push('利確 $'+(+h.tpPrice).toFixed(2)+'まで +'+td.toFixed(1)+'%'); } }
    if(lines.length) swx+='<div class="mut hld-plan">'+lines.join('<br>')+'</div>';
  }else if(h.initialStop!=null){
    swx+='<div class="mut hld-plan"><span class="mut">初期$'+(+h.initialStop).toFixed(2)+'＝R基準（固定）</span></div>';
  }
  if(h.exits&&h.exits.length){ swx+='<div class="mut hld-plan">部分決済済 '+(h.exits.length)+'回 → 残'+(h.remainingShares!=null?h.remainingShares:'—')+'/'+orig+'株</div>'; }
  var noteBits=[];
  if(h.setup) noteBits.push('<span class="hld-setup">'+_escH(h.setup)+'</span>');
  if(h.conv) noteBits.push('<span class="hld-conv">確信'+_escH(h.conv)+'</span>');
  if(h.envColor) noteBits.push('<span class="mut">環境'+_escH(h.envColor)+'</span>');
  if(h.eRS63!=null||h.eRS189!=null) noteBits.push('<span class="mut">入RS '+(h.eRS63!=null?h.eRS63:'—')+'/'+(h.eRS189!=null?h.eRS189:'—')+'</span>');
  var noteLine=noteBits.length?('<div class="hld-note">'+noteBits.join(' ')+'</div>'):'';
  var memoLine=h.memo?('<div class="hld-memo">📝 '+_escH(h.memo)+'</div>'):'';
  // #5 Core 12は途中利確しない＝部分決済ボタンは裁量スイングのみ
  var canPartial=(h.strat==='swing' && h.remainingShares>0);
  var closeBtn=(h.remainingShares>0)?'<button class="tkbtn hld-close" onclick="hldClose(event,'+i+')">全決済</button>':'<button class="tkbtn hld-close" onclick="hldClose(event,'+i+')">決済確定</button>';
  return '<tr data-tkone="'+_escH(h.t)+'"><td class="l tk">'+_escH(h.t)+' <span class="stratbadge '+meta.cls+'">'+meta.lab+'</span>'+plHtml
    +'<div class="mut hld-exit">出口: '+meta.exit+'</div>'+swx+noteLine+memoLine
    +'<div class="hld-btns">'
    +(canPartial?'<button class="tkbtn hld-pt" onclick="hldTakePartial(event,'+i+')">部分決済</button>':'')
    +closeBtn
    +'<button class="tkbtn hld-noteb" onclick="hldNote(event,'+i+')">✎ノート</button>'
    +'<button class="tkbtn hld-noteb" onclick="hldEdit(event,'+i+')">編集</button>'
    +'<button class="tkbtn" onclick="hldDel(event,'+i+')">削除</button></div></td>'
    +'<td>'+(sh!=null?sh:'—')+(h.remainingShares!=null&&orig!=null&&h.remainingShares!==orig?'<div class="mut" style="font-size:9px">残'+h.remainingShares+'</div>':'')+'</td>'
    +'<td>'+(avg!=null?('$'+(+avg).toFixed(2)):'—')+'</td>'
    +'<td><b>'+(days!=null?days+'日':'—')+'</b><div class="mut" style="font-size:9px">'+(h.dt||'')+'</div></td></tr>';
}
function _hldClosedRow(h,i){
  var r=_hldRealized(h), meta=_hldStratMeta(h.strat);
  var rtxt=(r.R!=null)?('<b class="'+(r.R>=0?'pos':'neg')+'">'+(r.R>=0?'+':'')+r.R.toFixed(2)+'R</b>'):'<span class="mut">R—</span>';
  var ptxt=(r.pnl!=null)?('<span class="'+(r.pnl>=0?'pos':'neg')+'">'+(r.pnl>=0?'+':'')+'$'+r.pnl.toFixed(0)+'</span>'):'';
  var exsum=(h.exits||[]).map(function(x){return (x.date||'')+' '+(x.shares||0)+'株@$'+(x.price!=null?(+x.price).toFixed(2):'—');}).join(' / ');
  return '<tr><td class="l tk">'+_escH(h.t)+' <span class="stratbadge '+meta.cls+'">'+meta.lab+'</span>'
    +'<div class="hld-note">'+rtxt+' '+ptxt+(h.heldDays!=null?' <span class="mut">'+h.heldDays+'日</span>':'')+(h.setup?' <span class="hld-setup">'+_escH(h.setup)+'</span>':'')+'</div>'
    +(exsum?'<div class="mut hld-plan">'+_escH(exsum)+'</div>':'')
    +(h.exitReason?'<div class="hld-memo"><b>手仕舞い</b>：'+_escH(h.exitReason)+'</div>':'')
    +(h.lesson?'<div class="hld-memo"><b>学び</b>：'+_escH(h.lesson)+'</div>':'')
    +'<div class="hld-btns"><button class="tkbtn hld-noteb" onclick="hldNote(event,'+i+')">✎ノート</button><button class="tkbtn hld-noteb" onclick="hldEditClosed(event,'+i+')">決済編集</button><button class="tkbtn" onclick="hldDel(event,'+i+')">削除</button></div></td>'
    +'<td colspan="3">'+(h.dt||'')+' → '+(h.closeDate||'')+'</td></tr>';
}
function hldRender(){
  var box=document.getElementById('hldList'); if(!box) return;
  var a=hldLoad();
  var actions='<div class="ci-row2" style="margin-top:8px;gap:6px;flex-wrap:wrap">'
    +'<button class="memx" onclick="hldExport()">📤 ノート書き出し(MD)</button>'
    +'<button class="memx" onclick="hldExportJSON()">💾 JSONバックアップ</button>'
    +'<button class="memx" onclick="hldImportJSON()">📥 JSON復元</button></div>';
  if(!a.length){ box.innerHTML='<div class="mut" style="font-size:11px;padding:8px 0">まだ記録なし。買った銘柄を上で追加。</div>'+actions; return; }
  var open=[], closed=[];
  a.forEach(function(h,i){ if(h.status==='closed') closed.push([h,i]); else open.push([h,i]); });
  var openBody=open.map(function(x){return _hldOpenRow(x[0],x[1]);}).join('');
  var openTbl=open.length?('<table class="ptab calc-tab"><thead><tr><th class="l">銘柄</th><th>株数</th><th>建値</th><th>経過日数</th></tr></thead><tbody>'+openBody+'</tbody></table>'):'<div class="mut" style="font-size:11px;padding:6px 0">保有中なし。</div>';
  var closedHtml='';
  if(closed.length){
    var cRs=closed.map(function(x){return _hldRealized(x[0]).R;}).filter(function(v){return v!=null;});
    var summ='';
    if(cRs.length){ var wins=cRs.filter(function(v){return v>0;}).length, sum=cRs.reduce(function(s,v){return s+v;},0);
      summ='勝率 '+(100*wins/cRs.length).toFixed(0)+'%（'+wins+'/'+cRs.length+'）・合計'+(sum>=0?'+':'')+sum.toFixed(1)+'R・平均'+(sum/cRs.length>=0?'+':'')+(sum/cRs.length).toFixed(2)+'R'; }
    var closedBody=closed.map(function(x){return _hldClosedRow(x[0],x[1]);}).join('');
    closedHtml='<details class="cxpl" style="margin-top:10px"><summary>決済済み '+closed.length+'件'+(summ?'（'+summ+'）':'')+'</summary><div class="cxpl-b">'
      +'<table class="ptab calc-tab"><tbody>'+closedBody+'</tbody></table></div></details>';
  }
  box.innerHTML=openTbl+closedHtml+actions
    +'<div class="mut" style="font-size:10.5px;margin-top:4px">実効株数・建値は<b>約定済み脚のみ</b>で計算（第2脚が未約定なら第1脚のみ）。全決済すると決済済みへ移動し記録は残ります（削除は誤登録用）。実現Rは<b>初期ストップ</b>基準。環境(NQ/RS/テーマ)は<b>記録日時点</b>のスナップショットで取得日当時の値ではありません。記録はこの端末にのみ保存＝<b>JSONバックアップ</b>推奨。</div>';
}
...
function swingCalc(){
  ...
  window._lastPlan={t:(_pk?(_pk.value||'').trim().toUpperCase():''), sh:shares, sh1:sh1, px1:e1, sh2:(hasE2?sh2:null), px2:(hasE2?p2:null), hasLeg2:hasE2,
...
function calcRun(){
  ...
  (C.names||[]).forEach(function(n){
    ...
    rows+='<tr><td class="l tk">'+rkb+' '+n.t+' '+flg+'<div class="mut" style="font-size:10px">'+sub+'</div></td>'
       +'<td>'+shCell+'</td>'
       +'<td><input class="entIn" type="number" inputmode="decimal" value="'+(_ce||'')+'" placeholder="建値" data-t="'+n.t+'" oninput="entSave(this)">'+entBtn+tkBtn+'</td>'
...
function entToggle(ev, b){
  ...
  var tk=b.getAttribute('data-tk'); coreToggleFilled(tk); _entApply();
...
def render(names, m, mri, breakdown, dropped, aux, setups, picks, cand,
    ...
    _wk_concl = ('<div class="card" style="border:1.5px solid rgba(56,189,248,.35)">'
                 ...
                 f'<div class="mut" style="font-size:11px;margin-top:3px">環境確認（露出判断の補助）：50日線上 <b>{breadth["pa50"]:.0f}%</b>　・　非常口 <b>{"発動中" if _wk_em else "未発動"}</b></div>'
