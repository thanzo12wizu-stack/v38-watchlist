...
Command Center — dashboard builder
  ...
  C. Market status = 地合いスコア (11-indicator weighted sum, raw 0-100, no L16 remap).
...
def main():
    ...
    if do_self:
        ...
        if errs:
            ...
            sys.exit(1)
        bs_, bys_ = leaders
        print("SELFTEST OK (6 tabs, status banner, N=%d, leaders=%d, buys=%d, sectors=%d, no None/nan)" %
