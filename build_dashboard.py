...
def track_holdings(prev, picks, color, asof_date, m=None, rebal_anchor=None, closes=None):
    ...
    # #1/#2: 実保有は「リバランス日・赤→青緑復帰・初回」だけ現在のトップ12を取り込む。
...
def build_movers_tab(m, s2t=None):
    ...
    def _row(tk, v, cls):
        ...
        return (f'<div class="mvr"><span class="mvr-t">{tk}{b3}</span>'
...
.cxpl{margin:2px 0 0}.cxpl>summary{list-style:none;cursor:pointer;font-size:10px;color:#6f8198;display:inline-flex;align-items:center;gap:3px;padding:1px 0;user-select:none}.cxpl>summary::-webkit-details-marker{display:none}.cxpl>summary::before{content:"\25B8";font-size:7px}.cxpl[open]>summary::before{content:"\25BE"}.cxpl-b{font-size:11px;line-height:1.55;color:#8b9bb0;margin:3px 0 2px}.chd{display:flex;justify-content:space-between;align-items:flex-start;gap:10px}.chd h2{margin:0}.chd-now{text-align:right;line-height:1.05;white-space:nowrap;flex:0 0 auto}.chd-now b{font-size:18px;font-weight:800;display:block;letter-spacing:-.01em}.chd-now span{font-size:10px;color:#7e8ea3;display:block;margin-top:1px;font-weight:600}.mv-wrap{display:flex;flex-direction:column;gap:14px;margin-top:6px}.mv-per-h{font-size:13px;font-weight:700;color:#cbd5e1;margin-bottom:6px;padding-bottom:3px;border-bottom:1px solid rgba(255,255,255,.08)}.mv-cols{display:grid;grid-template-columns:1fr 1fr;gap:10px}.mv-col-h{font-size:11px;font-weight:700;margin-bottom:4px;letter-spacing:.02em}.mvr{display:flex;justify-content:space-between;align-items:center;padding:2px 7px;border-radius:5px;font-size:12px}.mvr:nth-child(odd){background:rgba(255,255,255,.03)}.mvr-t{font-weight:600;color:#cbd5e1}.mvr-v{font-weight:700;font-variant-numeric:tabular-nums}.mv-sec-h{font-size:12px;font-weight:800;color:#a9bad0;margin:14px 0 6px;letter-spacing:.02em}.mv-sum{font-size:12px;color:#c3d0e0;padding:3px 0;line-height:1.5}.mv-mom{display:flex;gap:8px;align-items:baseline;padding:4px 0;font-size:12.5px}.mv-mom-l{font-weight:800;flex:0 0 auto;font-size:11px}.mv-mom-b{color:#cbd5e1;font-weight:600;line-height:1.5}.mvr-x{display:flex;gap:5px;align-items:center;flex:1 1 auto;justify-content:flex-end;margin:0 8px;overflow:hidden;flex-wrap:nowrap}.mvr-e{font-size:10px;color:#8b9bb0;font-weight:600;white-space:nowrap}.mvr-e.hot{color:#c7923f}.mvr-th{font-size:10px;color:#7e8ea3;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:78px}.mvr-3w{font-size:9px;font-weight:800;color:#fff;background:#5b7cc2;border-radius:4px;padding:0 4px;margin-left:5px;vertical-align:middle}details.mv-per>summary.mv-per-h{cursor:pointer;list-style:none}details.mv-per>summary.mv-per-h::-webkit-details-marker{display:none}details.mv-per>summary.mv-per-h::before{content:"▸ ";font-size:9px}details.mv-per[open]>summary.mv-per-h::before{content:"▾ "}@media(max-width:520px){.mv-cols{grid-template-columns:1fr}}
...
def selftest(html, picks, setups, sectors, mkt=None, W=None, cutdate=None):
    ...
    for sid in ["t-today","t-movers","t-market","t-weekly","t-port","t-alloc","t-rs","t-rotation","t-rules","t-post1","t-post2"]:
...
def main():
    ...
    if do_self:
        ...
        if errs:
            ...
            sys.exit(1)
        bs_, bys_ = leaders
        print("SELFTEST OK (11 tabs consolidated, restored pickup layout, X-ready market digest, market health v2, emergency brake, RS compare+IN/OUT+continuity, N=%d, leaders=%d, buys=%d, sectors=%d, no None/nan)" %
