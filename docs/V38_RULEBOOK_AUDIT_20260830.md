...
| Selective RS189 ranking | 研究で確認認済み | PASS | 監査版実装済み | Theme加点なし |
...
| `M30_TOUCH30_F80_D10` Entry | 研究候補 | PASS | Engine/Schema済み | Seed day=age0。`age<=30`＋TOUCH30＋MC57≥20。RISE30ではない |
