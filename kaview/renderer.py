...
from .almanac_enhanced import render_dashboard as _render_dashboard
from .cards import render_daily_card, render_portfolio_card, write_social_copy
...
def render_dashboard(report: JournalReport, path: Path) -> None:
    """Render the standalone, self-contained Almanac artifact."""
    ...
    staging = path.parent / ".almanac_sidecar.html"
