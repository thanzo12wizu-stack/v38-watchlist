...
s=p.read_text()
s=s.replace("for baseexp,bmc,bmax,fdd,frec,bexit,vp in itertools.product([.52,.54,.545,.55,.56,.58,.60],[60,65,70],[2.0,2.5,3.0],[-.065,-.075,-.085],[3,4,5],['raw','score1','score3'],[False,True]):", "for baseexp,bmc,bmax,fdd,frec,bexit,vp in itertools.product([.35,.40,.45,.50,.52],[60,65,70],[2.5],[-.055,-.065,-.075],[3,4],['score1'],[False,True]):")
s=s.replace("combos=['NONE','RG','RG+GB','RG+GB+BY','RG+GB+BY+RY']", "combos=['NONE','RG','RG+GB','RG+GB+BY']")
