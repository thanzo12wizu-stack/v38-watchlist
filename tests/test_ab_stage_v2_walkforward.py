        ...
        [
            {
                ...
                "trade_return_gross": 0.10,
                "outcome_date_10": "2026-01-06",
                "return_10": 0.10,
                "risk_fraction": 0.05,
                "individual_stage": "2A",
                "market_stage": "2A",
                "sector_stage_score": 80,
            },
            {
                "ticker": "BBB",
                "date": "2026-01-05",
...
def test_adoption_requires_improvement_and_no_guardrail_break():
    summary = pd.DataFrame(
        [
            {
                "spec": 11,
                "mean_top10_excess_return": 0.01,
                "mean_hit_3r_rate": 0.20,
                "mean_early_failure_rate": 0.40,
                "mean_brier_skill": 0.01,
                "mean_profit_factor": 1.10,
                "worst_max_drawdown": -0.20,
                "mean_portfolio_return": 0.10,
                "total_trades": 100,
            },
            {
                "spec": 12,
